...
# Create a model where the covariate is at 2
data$partnerLibido_at2 <- data$partnerLibido -.733
mean(data$partnerLibido_at2)
full.model.dum.at2 <- lm(libido ~ partnerLibido_at2 * dose, data)
summary(full.model.dum.at2)
